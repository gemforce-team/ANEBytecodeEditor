...
inline constexpr std::array<std::pair<const char*, SmallTrivialVector<OPCodeArgumentType, 4>>, 256>
    OPCode_Info = {
        {
         ...
         /* 0xF2 */ {"bkptline", {OPCodeArgumentType::UIntLiteral}},
         /* 0xF3 */ {"timestamp", {}},
...
inline constexpr BidirectionalMap OPCodeMap(std::invoke(
    []
    {
